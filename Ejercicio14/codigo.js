...
//Funcion para hacer la raiz cuadrada del numero en pantalla actual
...
//Funcion que nos resuelve el numero en pantalla entre 100
...
//Funcion que llamamos al pulsar el cambio de signo. Convierte el numero en pantalla de string a numero, le cambia el simbolo
//y vuelve a convertirlo en String.

function cambiarSigno(){
   numPantalla_numero=Number(numPantalla);
   numPantalla_numero=-numPantalla_numero;
   numPantalla=String(numPantalla_numero);
   pantalla.innerHTML=numPantalla;
}

//Funcion que divide 1 entre el numero actual en pantalla.

function inverso(){
   numPantalla_numero=Number(numPantalla);
   numPantalla_numero=(1/numPantalla_numero);
   numPantalla=String(numPantalla_numero);
   pantalla.innerHTML=numPantalla;
   numIniciar=1;
}
...
//Funcion para resetear el valor actual de la calculadora, manteniendo la operacion en curso.
